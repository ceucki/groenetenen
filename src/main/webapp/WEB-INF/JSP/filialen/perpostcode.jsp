...
<body>
	...
	<form:form action='${url}' commandName='postcodeReeks' method='get'>
		<form:label path='vanpostcode'>Van:<form:errors
				path='vanpostcode'></form:errors>
		</form:label>
		<form:input path='vanpostcode' autofocus='autofocus' type='number' required='required' min='1000' max='9000'/>
		<form:label path='totpostcode'>Tot: <form:errors
				path='totpostcode' />
		</form:label>
		<form:input path='totpostcode' type='number' required='required' min='1000' max='9000'/>
